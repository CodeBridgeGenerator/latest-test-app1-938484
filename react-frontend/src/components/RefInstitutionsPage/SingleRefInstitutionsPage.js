...
const SingleRefInstitutionsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleRefInstitutionsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleRefInstitutionsId]);


    const goBack = () => {
        navigate("/refInstitutions");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">RefInstitutions</h3>
                </div>
                <p>refInstitutions/{urlParams.singleRefInstitutionsId}</p>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Program</label><p className="m-0 ml-3" >{_entity?.program}</p></div>
...
export default connect(mapState, mapDispatch)(SingleRefInstitutionsPage);
