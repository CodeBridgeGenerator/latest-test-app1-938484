...
import SingleApplicationsPage from "../components/ApplicationsPage/SingleApplicationsPage";
import ApplicationProjectLayoutPage from "../components/ApplicationsPage/ApplicationProjectLayoutPage";
import SingleApplicationStatusPage from "../components/ApplicationStatusPage/SingleApplicationStatusPage";
import ApplicationStatusProjectLayoutPage from "../components/ApplicationStatusPage/ApplicationStatusProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/applicationStatus/:singleApplicationStatusId" exact element={<SingleApplicationStatusPage />} />
<Route path="/applicationStatus" exact element={<ApplicationStatusProjectLayoutPage />} />
